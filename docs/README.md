...
This folder contains the current business context, CRM verification notes, product architecture, and historical analysis for the Step and Repeat LA Copper CRM project.

The active documents below should be treated as the current starting point. Archived documents are retained for history but should not be used as the primary source of truth.
